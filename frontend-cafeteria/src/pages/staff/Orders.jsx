              ...
              <div className="p-4 bg-gray-50 border-t border-gray-100 rounded-b-xl flex gap-3">
                {order.status === 'pending' && (
                  <button
                    ...
                    className="flex-1 inline-flex justify-center items-center px-4 py-2 border border-transparent text-sm font-medium rounded-lg text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors shadow-sm"
                  >
                    Start Preparing
                  </button>
                )}
